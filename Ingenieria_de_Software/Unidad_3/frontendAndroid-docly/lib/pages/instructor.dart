...
class _InstructorPageState extends State<InstructorPage> {
  ...
  Future<void> _enviarDatosApi() async {
    ...
    // 1. Calculamos el total de horas iterando sobre los temas (esto se queda igual)
    int totalHoras = 0;
    ...
    // 2. Construimos el payload (esto se queda igual)
    final payload = {
      "curso": {
    ...
    // 3. --- LA MAGIA DE LA LIMPIEZA ---
    // Llamamos a nuestro servicio y esperamos su respuesta
    final resultado = await ApiService.registrarCurso(payload);

    setState(() {
      _isLoading = false; // Apagamos el circulito de carga
    });

    // 4. Mostramos el mensaje dependiendo de si fue un éxito o un error
    if (resultado['exito'] == true) {
      _mostrarMensaje(resultado['mensaje'], Colors.green);
      Navigator.pop(context); // Cierra la pantalla si fue exitoso
    } else {
  ...
  void _mostrarConfirmacion() {
    // Calculamos las horas totales para mostrarlas en el resumen
    int totalHoras = 0;
    for (var tema in _temas) {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  'MODALIDAD: $tipoSeccion', // Usamos la variable que configuramos antes
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // --- AHORA TODOS ESTÁN EN FILA VERTICAL ---
          ...
          actions: [
            // Botón Rojo (Corregir)
            ElevatedButton(
              onPressed: () => Navigator.pop(context), // Solo cierra el Dialog
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _enviarDatosApi(); // Llama a tu función que conecta con render
              },
              style: ElevatedButton.styleFrom(
  ...
  // Widget auxiliar para que el texto del resumen se vea ordenado
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.blueGrey.shade100, // Fondo gris oscuro de la web
      appBar: AppBar(
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const SizedBox(
                      height: 12,
                    ), // Pequeño espacio para que respire
                    Container(
                      padding: const EdgeInsets.symmetric(
                        horizontal: 12,
                        vertical: 6,
