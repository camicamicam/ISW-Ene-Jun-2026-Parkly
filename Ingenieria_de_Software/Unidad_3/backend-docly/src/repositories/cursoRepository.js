        ...
        const queryCurso = `
                BEGIN
                    alta_curso(
                        ...
                        :p_nombre_curso, :p_duracion, :p_total_horas, :p_cupo_maximo, :p_anio, 
            ...
            const bindVarCurso = {
                ...
                // Salida
                p_id_curso_gen: { dir: oracledb.BIND_OUT, type: oracledb.NUMBER
...
async function obtenerCursos() {
    ...
    try {
        ...
        const query = `SELECT * FROM v_detalle_cursos ORDER BY id_curso ASC`;
