...
class _DocentePageState extends State<DocentePage> {
  ...
  // --- FUNCIÓN QUE ABRE EL FORMULARIO DESDE ABAJO ---
  void _abrirFormulario(dynamic curso) {
    showModalBottomSheet(
      context: context,
      isScrollControlled:
          true, // Permite que ocupe más pantalla si es necesario
      backgroundColor: Colors.transparent,
      builder: (context) =>
          FormularioInscripcion(curso: curso, tipoSeccion: tipoSeccion),
    );
  }
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () =>
                  _abrirFormulario(curso), // LLAMAMOS AL FORMULARIO
...
// =====================================================================
// NUEVO WIDGET: FORMULARIO DE INSCRIPCIÓN (Se desliza desde abajo)
// =====================================================================
class FormularioInscripcion extends StatefulWidget {
  final dynamic curso;
  ...
  @override
  State<FormularioInscripcion> createState() => _FormularioInscripcionState();
}

class _FormularioInscripcionState extends State<FormularioInscripcion> {
  ...
  int? _plazaSeleccionada;
  int? _deptoSeleccionado;
  bool _isLoading = false;

  final List<Map<String, dynamic>> _plazas = [
  ...
  // --- PASO 2: MANDAR A LA BASE DE DATOS ---
  void _ejecutarInscripcionFinal() async {
    ...
    final payload = {
      ...
      "id_plaza": _plazaSeleccionada,
      "id_curso": int.tryParse(widget.curso['ID_CURSO'].toString()) ?? 0,
    };

    print('ENVIANDO INSCRIPCIÓN: $payload');
    final resultado = await ApiService.inscribir(payload, widget.tipoSeccion);
    ...
    if (resultado['exito'] == true) {
      Navigator.pop(context); // Cierra el formulario inferior
              ...
              children: [
                Expanded(
                  child: _buildDropdown(
                    ...
                    _plazaSeleccionada,
                    _plazas,
                    (val) => setState(() => _plazaSeleccionada = val),
                  ),
                ),
                const SizedBox(width: 16),
                Expanded(
