      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            ...
            ), // Tu ruta exacta de la imagen
            fit: BoxFit.contain, // Mantiene la proporción de tu logo
            colorFilter: ColorFilter.mode(
              Colors.white.withOpacity(
                0.25,
              ), // Nivel de transparencia (0.85 es casi invisible)
              BlendMode.dstATop,
            ),
          ),
        ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    hint: const Text("Cursos Profesional"),
                    value: _tipo,
                    isExpanded:
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    hint: const Text("Cursos Docente"),
                    value: _tipo,
                    isExpanded:
                        true, // Hace que el botón ocupe todo el ancho del contenedor
                    underline: Container(), // Quitamos la línea fea de abajo
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    Navigator.pushNamed(context, 'loginConstancia');
                  },
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: Colors.deepOrange, // Color llamativo
